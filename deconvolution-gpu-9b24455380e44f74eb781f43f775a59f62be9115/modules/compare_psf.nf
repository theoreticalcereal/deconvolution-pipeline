process COMPARE_PSF {
    ...
    tag "${params.cell_name ?: file(input_dir).name}"

    publishDir "${params.output_dir}/comparison", mode: 'copy'
    ...
    stub:
    """
    echo "COMPARE_PSF stub for ${input_dir}" > compare_psf_stub.txt
    """
}
